...
export const FAQAccordionData = [
    ...
    {title: "What are the fees?", description: "Our Fee is depending on your business with the case by case."},
];

export const NewsData = [
    { 
        title : "Getting Ready for Bitcoin's Catalysts", 
        description : "How exchange-traded funds and futures contracts can reach TradFi and turbocharge the growth of crypto markets.", image : "https://www.coindesk.com/resizer/ProcCSQ3kW3jpHImBmJm-RAyN9Y=/1056x594/filters:quality(80):format(webp)/cloudfront-us-east-1.images.arcpublishing.com/coindesk/UBBRECAHBZFGNKVK7NT6WFBHVY.jpg", 
        day: "10", 
        date: "November, 2023" 
    },
    { title : "Bitcoin Fund Holdings Hit All-Time High as Spot ETF Excitement Entices Crypto Investors", description : "Digital asset funds surpassed $1 billion in net inflows this year, with money overwhelmingly flowing into BTC-focused investments, CoinShares reported.", image : "https://www.coindesk.com/resizer/L9X4v6ACQvS07WR0-B9voZ9w4eE=/1056x582/filters:quality(80):format(webp)/cloudfront-us-east-1.images.arcpublishing.com/coindesk/MT3AJF57YBEF3EBQFIUNRQIXFM.png", day: "10", date: "November, 2023" },
    { title : "Building the Future of Finance: An Interview With Bitazza Co-Founder Kevin Heng", description : "The rapidly evolving landscape of technology and computing has consumed finance. Once only available to a few, the disruption of the financial industry through technology has made finance accessible to everyone.", image : "https://www.coindesk.com/resizer/dBIUOEzx3ZU47bwDE01lVbop6yM=/1056x792/filters:quality(80):format(webp)/cloudfront-us-east-1.images.arcpublishing.com/coindesk/FRJPW3SICFH5RKVDEEOOASOBXM.jpg", day: "10", date: "November, 2023" },
